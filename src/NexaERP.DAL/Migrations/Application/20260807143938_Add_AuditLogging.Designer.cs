...
namespace NexaERP.DAL.Migrations.Application
{
    ...
    [Migration("20260807143938_Add_AuditLogging")]
    partial class Add_AuditLogging
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexaERP.DAL.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IdentityId")
                        .HasDatabaseName("ix_audit_logs_identity_id");

                    b.ToTable("AuditLogs", "nexa_erp");
                });
            ...
            modelBuilder.Entity("NexaERP.DAL.Entities.PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_purchase_orders_user_id");
            ...
            modelBuilder.Entity("NexaERP.DAL.Entities.Order", b =>
                {
                    ...
                    b.HasOne("NexaERP.DAL.Entities.User", null)
                        .WithMany()
